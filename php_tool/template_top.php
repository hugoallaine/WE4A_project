                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form id="formPostId" class="formPost" method="POST" action="">
                                ...
                                <textarea id="textAreaPostId" name="textAreaPostId" class="form-control resize-none" placeholder="Saisir un message" required style="resize: none; height:20vh"></textarea>
